import {menuActive,reportWindow,addPin,hidePin,deleteInSecondStorage,reportWindowInStoraje} from "./listner";

export default function secondDesc(element) {
    let cardImg = new Image();
            cardImg.src = element.img;
            let userAvatar = new Image();
            userAvatar.src = element.avatar;

            const conteiner = document.querySelector('.secondDesck');
            ...
            menuListItemHide.addEventListener('click',()=>deleteInSecondStorage(element,cardWrap,));
    }   