import {menuActive,reportWindow,addPin,hidePin,deleteInThirdStorage,reportWindowInStoraje} from "./listner";

export default function thirdDesc(element) {
    let cardImg = new Image();
            cardImg.src = element.img;
            let userAvatar = new Image();
            userAvatar.src = element.avatar;

            const conteiner = document.querySelector('.thirdDesck');
            ...
            //Скрыть пин
            menuListItemHide.addEventListener('click',()=>deleteInThirdStorage(element,cardWrap,));
    }   